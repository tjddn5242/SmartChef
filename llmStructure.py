...
def gptOutput(user_need, ingredients, disease):
    ...
    **중요: 아래 형식에 맞추어 정확히 답변해 주세요. 추가 정보나 텍스트는 추가하지 마세요.**
    <영양사의 한 마디>
    영양사의 한 마디를 출력하세요.

    <음식명1>
    음식명1을 출력하세요.
    - <추가구비재료1>: 요리에 사용하는 모든 재료 중, [재료]에 없는 재료를 출력하세요.
    - <사용재료1>: 요리에 사용하는 모든 재료를 출력하세요.
    - <레시피1>: 레시피를 출력하세요. 상세하게 설명해야하며 단계별로 출력하세요. e.g. 1. 물을 올리세요 2. 라면을 넣으세요. ...
    - <요리시간1>: 요리에 소요되는 시간을 출력하세요.

    <음식명2>
    음식명2을 출력하세요.
    - <추가구비재료2>: 요리에 사용하는 모든 재료 중, [재료]에 없는 재료를 출력하세요.
    - <사용재료2>: 요리에 사용하는 모든 재료를 출력하세요.
    - <레시피2>: 레시피를 출력하세요. 상세하게 설명해야하며 단계별로 출력하세요. e.g. 1. 물을 올리세요 2. 라면을 넣으세요. ...
    - <요리시간2>: 요리에 소요되는 시간을 출력하세요.

    <음식명3>
    음식명3을 출력하세요.
    - <추가구비재료3>: 요리에 사용하는 모든 재료 중, [재료]에 없는 재료를 출력하세요.
    - <사용재료3>: 요리에 사용하는 모든 재료를 출력하세요.
    - <레시피3>: 레시피를 출력하세요. 상세하게 설명해야하며 단계별로 출력하세요. e.g. 1. 물을 올리세요 2. 라면을 넣으세요. ...
    - <요리시간3>: 요리에 소요되는 시간을 출력하세요.
    """
